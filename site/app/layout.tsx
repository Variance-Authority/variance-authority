...
const DESCRIPTION =
  "Visual regression that names the component and the file:line behind a changed pixel, reuses every answer that still holds, and senses presentation and scenario evidence a coding agent can read.";
