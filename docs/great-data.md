...
| [Workspace API](agent-workspace-api.md) | Package manifests, exports, imports, declarations, import sites, and a resolved module graph in one dated workspace generation | Is this name already exported here, and which related files import it? |
