...
Presentation intelligence can identify a collapsed separation, an alignment
outlier, a drifting peer, or a prominence relationship that became
indistinguishable. It can paint the measurements so a reader can challenge the
grouping. Telemetry such as density or unused space remains context and cannot
