...
| [0005](0005-ci-integration.md) | CI integration and PR feedback | 0003, 0004 | `built, never run` | [`.github/workflows/variance.yml`](../../.github/workflows/variance.yml) and `variance comment` are committed. Neither has executed once. |
