...
| function entry | 2,553 | entered, and owns every statement before the first decision |
...
other two columns — 13,685 statements collapse to 2,122 continuations, because a
