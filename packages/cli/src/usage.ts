...
export const USAGE = [
  ...
  'variance ask     [--config <path>] [<question>] [--subject <id>] [--subjects <id>[,...]] [--component <name>] [--rule <id>] [--shape <digest>] [--claims <path>] [--test <id>] [--state <state>] [--file <text>] [--query <words>] [--from <path|words>] [--limit <n>] [--at <address>] [<report>...]',
