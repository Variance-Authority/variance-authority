...
| Connecting two examples that share a component | [`docs/composition.md`](docs/composition.md) — the suite compared to itself at one commit, why each component moved, and why *unexplained* is not yet *flake* |
