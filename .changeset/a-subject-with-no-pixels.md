...
'@variance-authority/observe': minor
'@variance-authority/raster': minor
...
'@variance-authority/png': patch
'@variance-authority/remote': patch
'@variance-authority/playwright-test': patch
---

A subject with no pixels is a baseline without an image, not a subject that got away
