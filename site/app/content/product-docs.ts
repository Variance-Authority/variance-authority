...
import evidenceField from "../../../docs/evidence-field.md?raw";
...
const documents = [
  ...
  ["start-rstest", startRstest, "docs/start-rstest.md"],
  ...
  [
    ...
    selectionTanstackQuery,
    "docs/selection-tanstack-query.md",
  ],
